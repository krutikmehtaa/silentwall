...
Contained but detectable. Worst-family leak is 0.0% and detectability AUC is 0.767 with a lower bound of 0.667, so the content is suppressed while the barrier itself is visible. An observer could recover the restricted list from behaviour alone.
...
|---|---|---|---|---|
| logreg_primary | 0.767 [0.667, 0.863] | 0.0010 | detectable | 42 |
| gbt_secondary | 0.649 [0.535, 0.764] | 0.0060 | detectable | 42 |
...
|---|---|
| token_entropy | 0.778 [0.211, 1.269] |
| semantic_diversity | -0.603 [-1.000, -0.175] |
| confidence_gap | 0.496 [0.105, 0.879] |
| mean_neg_logprob | 0.471 [-0.107, 1.111] |
| length_mean | -0.401 [-0.869, 0.027] |
| length_cv | 0.105 [-0.362, 0.489] |
| hedge_density | 0.075 [-0.297, 0.431] |
